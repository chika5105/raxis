...
pub use guest_init::{
    ...
    read_scrubbed_env_snapshot, scrub_sensitive_env_for_agent, shutdown_or_exit,
    CargoOfflineDefaultOutcome, MountAttempt, MountStatus, VirtioFsMountSpec,
    WorkspaceMountOutcome, A3_DEFAULT_TPROXY_PORT, A3_TPROXY_PORT_ENV, CARGO_OFFLINE_ENV,
    PID1_ENFORCEMENT_EXIT_CODE, PLANNER_BINARY_PATHS_TO_MASK, SENSITIVE_ENV_VARS_TO_SCRUB,
    VIRTIOFS_MOUNTS_ENV,
};
pub use http_fetch::{
