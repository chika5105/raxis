...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    state                  TEXT    NOT NULL
        CHECK (state IN ('Admitted', 'GatesPending', 'Running', 'Completed', 'Failed', 'Aborted', 'Cancelled', 'BlockedRecoveryPending')),
    block_reason           TEXT,
    actor                  TEXT    NOT NULL,
...
CREATE TABLE IF NOT EXISTS escalations (
    ...
    status                TEXT    NOT NULL DEFAULT 'Pending'
        CHECK (status IN ('Pending', 'Approved', 'Denied', 'TimedOut', 'TokenExpired', 'Consumed')),
    created_at            INTEGER NOT NULL,
