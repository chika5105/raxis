...
pub struct EscalationRequest {
    ...
    /// send this empty; the host dispatcher stamps the canonical DB
    /// token before the request reaches admission so the handler can
    /// recover session_id, lineage_id, and initiative_id.
