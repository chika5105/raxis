...
mod wire {
    ...
    pub(super) struct Status {
        #[prost(string, tag = "2")]
        pub message: String,
        #[prost(enumeration = "status_code::StatusCode", tag = "3")]
        pub code: i32,
    }
    ...
    pub(super) struct SpanProto {
        ...
        #[prost(string, tag = "5")]
        pub name: String,
        #[prost(enumeration = "span_kind::SpanKindProto", tag = "6")]
        pub kind: i32,
        #[prost(fixed64, tag = "7")]
    ...
    pub(super) struct Sum {
        ...
        #[prost(
            enumeration = "aggregation_temporality::AggregationTemporality",
            tag = "2"
        )]
    ...
    pub fn encode_spans(
        ...
        let span_protos: Vec<SpanProto> = spans
            .iter()
            .map(|s| SpanProto {
        ...
        let metric_protos: Vec<Metric> = metrics
            ...
            .map(|m| {
                ...
                let datum = match (&m.metric_type, &m.datapoint) {
                    (MetricType::Counter, RxDataPoint::Sum { value }) => metric::Data::Sum(Sum {
...
mod tests {
    use super::*;
    use raxis_observability::types::{
        AttrMap, AttrValue, DataPoint, MetricData, MetricName, MetricType, SpanData, SpanEvent,
    ...
    fn sample_span() -> SpanData {
        ...
        attrs.insert(
            ...
            AttrValue::Str("CompleteTask".into()),
        );
    ...
    fn histogram_bucket_counts_use_packed_fixed64_wire_format() {
        ...
        let body = wire::encode_metrics(&[sample_histogram()], "0.1.0", &sample_resource());
