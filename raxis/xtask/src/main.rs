    ...
    match target.as_deref() {
        ...
        None => anyhow::bail!(
            "usage: cargo xtask <target> [flags]\n\
             ...
             images bake                                — single-command end-to-end image bake:\n                 [--role <ROLE>]...                        preflight host inputs, stage vmlinux,\n                 [--install-dir <PATH>]                    build role rootfs where needed,\n                 [--signing-key <PATH>]                    cross-compile guest binaries, pack\n                 [--builder <B>]                           signed initramfs images, and write\n                 [--kernel-from-file <PATH>]               <install_dir>/images/<stem>-<kver>.bake.json\n                 [--force] [--no-cache]                    with source/input/output SHA-256s.\n                                                          Re-runs are fast no-ops only when\n                                                          source fingerprints and outputs match.\n                                                          Stages the Linux guest kernel at\n                                                          <install_dir>/kernel/vmlinux.\n  \
             ...
             images verify-trust-anchor                 — verify a built raxis-kernel binary\n                 [--kernel <PATH>]                          embeds the expected image-signing\n                 [--expected-pk-hex <HEX>]                  public key. Defaults to\n                                                            RAXIS_KERNEL_BINARY, target/release,\n                                                            target/debug, then PATH.\n  \
