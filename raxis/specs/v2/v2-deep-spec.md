...
**Admission precondition — two retry-eligibility classes (`INV-RETRY-FROM-COMPLETED-REVIEW-REJECTED-01`).** `handle_retry_sub_task` admits a `RetrySubTask` against a prior activation row in exactly two states:
