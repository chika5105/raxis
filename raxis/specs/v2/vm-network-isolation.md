...
> **Path A3 (universal-airgap; the only egress path shipped in V2).** This
> document captures the historical Tier-1 admission contract that Path A3
> inherits. The VM has **no** virtio-net device at all
