...
| **Nonce sweep (§8.4)** | Pending | Periodic-maintenance hook calling `raxis-store::plan_bundles::sweep_expired_nonces` from the kernel maintenance loop on its configured cadence. |
