...
- [x] `OperatorRequest::CreateInitiativeV2` decoder accepts only the V2 wire shape (`raxis-types::operator_wire`); V1 `CreateInitiative` JSON shape remains a separate variant — `serde` rejects malformed mixes at decode.
