...
Reviewer-rejection retry (`INV-RETRY-FROM-COMPLETED-REVIEW-REJECTED-01`):
  ...
  // `INV-AUDIT-PAIRED-06`.
  OrchestratorRespawnCeilingExceeded                  // paired with initiatives state=Failed UPDATE
