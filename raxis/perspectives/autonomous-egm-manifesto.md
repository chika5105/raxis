...
## 3. Escaping the Latency Trap: Contract Boundaries and Two-Speed Execution
...
Running an autonomous workforce locally requires strict environmental hygiene to prevent an agent from overwhelming your workstation or laundering malicious inputs:
...
*   **Parallelism Caps:** To prevent the "agentic fork bomb," global orchestration policies must cap concurrent exploration branches and maximum verifier runs per hour.
