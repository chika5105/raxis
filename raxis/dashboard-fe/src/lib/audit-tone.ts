...
const SUFFIX_RULES: ReadonlyArray<readonly [RegExp, AuditTone]> = [
  ...
  [
    /(Created|Started|Spawned|Submitted|Installed|Registered|Updated|Advanced|Selected|Admitted|Enqueued|Granted|Rotated|Emitted|Pushed|Scaled|Served|Used|Executed|Read|Accessed|Forwarded|Refreshed|Hit|Applied|Substituted)$/,
    "info",
  ],
];
